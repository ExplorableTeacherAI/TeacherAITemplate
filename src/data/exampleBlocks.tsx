        ...
        <Block id="table-of-contents" padding="sm">
            <Table
                ...
                rows={[
                    ...
                    { cells: [<div className="font-semibold"><InlineHyperlink id="link-toc-layouts" targetBlockId="demo-title">Layouts & Containers</InlineHyperlink></div>, 'Responsive multi-column, grid, scrolling, and sliding layouts.'] },
